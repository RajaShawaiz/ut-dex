...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info/pools': { title: t('Staking'), description: 'View statistics for Pancakeswap exchanges.' },
    ...
    defaultTitleSuffix: t('UtilisToken Swap'),
  }
}
